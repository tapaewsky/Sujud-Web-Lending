  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col gap-6">
        ...
        <div>
          <h3 className="text-sm font-semibold text-[#EDEDEF] mb-2">2.3 Имя пользователя</h3>
          <p className="mb-3">
            Мы можем сохранять имя пользователя, указанное вами в приложении, в нашей базе данных.
          </p>
          <p className="mb-3">Это необходимо для:</p>
          <ul>
            <li>отображения профиля пользователя внутри приложения</li>
            <li>персонализации пользовательского опыта</li>
            <li>идентификации пользователя в рамках функционала аккаунта</li>
          </ul>
          <p className="text-[#8A8F98]/80 text-sm border-l-2 border-[#30D158]/40 pl-3 mt-3">
            Имя пользователя хранится безопасно и не передаётся третьим лицам.
          </p>
        </div>
  
        <div>
          <h3 className="text-sm font-semibold text-[#EDEDEF] mb-2">2.4 Пользовательский контент</h3>
